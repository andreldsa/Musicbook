...
public class Usuario implements Serializable {
	...
	public int criarTag(String tag, int tagId) throws TagInvalidaException {
	...
	public List<Integer> getTagsDisponiveis() {
		List<Integer> lista = new ArrayList<Integer>();
		lista.addAll(tags.keySet());
		return lista;
	}
	...
	public int getIdTag(String tag) {
		for (Integer id : tags.keySet()) {
			if (tags.get(id).equalsIgnoreCase(tag)) {
				return id;
			}
		}
		return 0;
	...
	public String getTagNome(int idTag) throws TagInvalidaException {
		if (tags.containsKey(idTag)) {
			return tags.get(idTag);
		}
