...
public class TestaOurTime {
	...
	public void setUp() throws DiaInvalidoException, MesInvalidoException, AnoInvalidoException{
		data1 = new OurTime(20,5,2014);
		data2 = new OurTime(25,3,2015,18,20,45);
		data3 = new OurTime();
	}
	...
	@Test(expected = DiaInvalidoException.class)
	public void testaDiaInvalido2() throws DiaInvalidoException, MesInvalidoException, AnoInvalidoException{
	...
	@Test(expected = DiaInvalidoException.class)
	public void testaDiaInvalido4() throws DiaInvalidoException, MesInvalidoException, AnoInvalidoException{
	...
	@Test(expected = DiaInvalidoException.class)
	public void testaDiaInvalido6() throws DiaInvalidoException, MesInvalidoException, AnoInvalidoException{
	...
	@Test(expected = DiaInvalidoException.class)
	public void testaDiaInvalido8() throws DiaInvalidoException, MesInvalidoException, AnoInvalidoException{
	...
	@Test(expected = MesInvalidoException.class)
	public void testaMesInvalido2() throws DiaInvalidoException, MesInvalidoException, AnoInvalidoException{
	...
	@Test(expected = MesInvalidoException.class)
	public void testaMesInvalido4() throws DiaInvalidoException, MesInvalidoException, AnoInvalidoException{
	...
	@Test(expected = AnoInvalidoException.class)
	public void testaAnoInvalido2() throws DiaInvalidoException, MesInvalidoException, AnoInvalidoException{
	...
	@Test(expected = AnoInvalidoException.class)
	public void testaAnoInvalido4() throws DiaInvalidoException, MesInvalidoException, AnoInvalidoException{
	...
	public void testaAno() {
		assertEquals(2014, data1.getAno());
		assertEquals(2015, data2.getAno());
	...
	public void testaDataToString(){
		assertEquals("20/05/2014", data1.getDataToString());
		assertEquals("25/03/2015", data2.getDataToString());
		StringBuilder dataAtual = new StringBuilder();
		if(new GregorianCalendar().get(GregorianCalendar.DAY_OF_MONTH) < 10)
			dataAtual.append("0");
