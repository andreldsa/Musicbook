...
public class TestaSistema {
	...
	public void testaLoginInvalido1() throws LoginInvalidoException, UsuarioInexistenteException{
		sistema.abrirSessao("Joao.Silva","jiao123");
	}
	
	@Test(expected = LoginInvalidoException.class)
	public void testaLoginInvalido2() throws LoginInvalidoException, UsuarioInexistenteException{
		sistema.abrirSessao("Joao.Silva","ze123");
	}
	
	@Test(expected = LoginInvalidoException.class)
	public void testaLoginInvalido3() throws LoginInvalidoException, UsuarioInexistenteException{
		sistema.abrirSessao(null,"joao123");
	}
	
	@Test(expected = LoginInvalidoException.class)
	public void testaLoginInvalido4() throws LoginInvalidoException, UsuarioInexistenteException{
		sistema.abrirSessao("","joao123");
	}
	
	@Test(expected = LoginInvalidoException.class)
	public void testaLoginInvalido5() throws LoginInvalidoException, UsuarioInexistenteException, SessaoInexistenteException{
		int idSessaoJoao = sistema.abrirSessao("Joao.Silva", "joao123");
	...
	@Test(expected = LoginInvalidoException.class)
	public void testaLoginInvalido6() throws LoginInvalidoException, UsuarioInexistenteException, SessaoInexistenteException{
		int idSessaoJoao = sistema.abrirSessao("Joao.Silva", "joao123");
	...
	public void testaSomInvalido5() throws SessaoInexistenteException, SomInvalidoException, LoginInvalidoException, UsuarioInexistenteException, SomInexistenteException{
		int idSessao = sistema.abrirSessao("Joao.Silva","joao123");
