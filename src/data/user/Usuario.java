...
public class Usuario {
	...
	//Mapa que indica a quantidade de sons que favoritei(valor) de um dado usuario(key);
	...
	public void atualizaFavoritagensDoUsuario(Integer userId){
		if(favoritagensDoUsuario.containsKey(userId)){
			favoritagensDoUsuario.put(userId, favoritagensDoUsuario.get(userId)+1);
		}else {
			favoritagensDoUsuario.put(userId, 1);
		}
	}
	/**
	 * Retorna o numero de vezes que o Usuario favoritou um som do usuario que tem o dado Id
	 * @param userId o Id do usuario que teve sons favoritados
	 * @return o nomero de vezes
	 */
	public Integer getFavoritagensDoUsuario(Integer userId){
		return favoritagensDoUsuario.get(favoritagensDoUsuario) == null ? 0 :
			favoritagensDoUsuario.get(favoritagensDoUsuario);
	}
	/**
	 ...
	 * @param sons a lista de Id dos sons
	 */
