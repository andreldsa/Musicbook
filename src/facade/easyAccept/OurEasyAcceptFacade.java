...
public class OurEasyAcceptFacade {
	...
	public int criarTag(String idSessao, String tag) throws TagInvalidaException, SessaoInexistenteException, SessaoInvalidaException{
		int idSessaoInt = idSessaoCheck(idSessao);
		return sistema.criarTag(idSessaoInt, tag);
	}
	
	public void adicionarTagASom(String idSessao, String tag, String som)
			throws SomInvalidoException, SessaoInvalidaException,
			SessaoInexistenteException, TagInvalidaException {
		int idSessaoInt = idSessaoCheck(idSessao);
		...
		sistema.postarTagNoSom(idSessaoInt, tag, Integer.parseInt(som));
		
	}
	
	public String getListaTagsEmSom(String idSessao, String som)
			throws NumberFormatException, SessaoInexistenteException,
			SomInvalidoException, SessaoInvalidaException {
		int idSessaoInt = idSessaoCheck(idSessao);
		if(som == null || som.isEmpty()){
			throw new SomInvalidoException("Som inválido");
		}
		return sistema.getListaTagsEmSom(idSessaoInt, Integer.parseInt(som)).toString()
				.replace('[', '{').replace(']', '}').replace(" ", "");
		}
	...
	public String getNomeTag(String idSessao, String tag)
		...
		return sistema.getNomeTag(idSessaoInt, Integer.parseInt(tag));
	}
	
	public String getTagsDisponiveis(String idSessao) throws SessaoInexistenteException, SessaoInvalidaException{
		int idSessaoInt = idSessaoCheck(idSessao);
		return sistema.getTagsDisponiveis(idSessaoInt).toString()
				.replace('[', '{').replace(']', '}').replace(" ", "");
	}
